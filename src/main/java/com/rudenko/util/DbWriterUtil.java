...
public class DbWriterUtil
{
    ...
    private static final String DB_URL = "jdbc:postgresql://" + DB_SERVER + ":" + DB_PORT + "/" + DB_INSTANCE;
    ...
    private static void addMoviesToDb( Set<Movie> movieList )
    {
        ...
        try (Connection connection = getPostgreSQLConnection())
        {
            ...
            PreparedStatement mProductionCompanyStatement = connection.prepareStatement( INSERT_M_PRODUCTION_COMPANY );
